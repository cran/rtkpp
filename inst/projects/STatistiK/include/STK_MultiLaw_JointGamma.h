...
/** @file STK_MultiLaw_JointGamma.h
 *  @brief In this file we define the joint Gamma probability law.
 **/

#ifndef STK_MULTILAW_JOINTGAMMA_H
#define STK_MULTILAW_JOINTGAMMA_H
...
class JointGamma: public JointProbability<RowVector, Law::Gamma>
{
  public:
...
#endif /* STK_MULTILAW_JOINTGAMMA_H */
