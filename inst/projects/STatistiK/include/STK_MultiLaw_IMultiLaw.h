...
/** @file STK_MultiLaw_IMultiLaw.h
 *  @brief In this file we define the Interface base classes IMultiLaw
 *  and JointProbability.
 **/
...
class IMultiLaw: public Law::ILawBase
{
  protected:
    /** Constructor. */
    IMultiLaw( String const& name) : Law::ILawBase(name) {}
...
#endif /* STK_MULTILAW_ITMULTILAW_H */
