...
/** @file STK_MultiLaw_JointCauchy.h
 *  @brief In this file we define the joint Cauchy probability law.
 **/

#ifndef STK_MULTILAW_JOINTCAUCHY_H
#define STK_MULTILAW_JOINTCAUCHY_H
...
class JointCauchy: public JointProbability<RowVector, Law::Cauchy>
{
  public:
...
#endif /* STK_MULTILAW_JOINTCAUCHY_H */
