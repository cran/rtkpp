 ...
 **/
template<typename Derived, template<class> class Visitor>
class VisitorByCol : public VisitorByColBase< Derived, Visitor >, public TRef<1>
{
  public:
    typedef typename Derived::Type Type_;
    typedef typename Visitor<Type_>::return_type Type;
...
/** @ingroup SlicingVisitors
  * @brief implement the access to the elements.
  **/
template<typename Derived, template<class> class Visitor>
class VisitorByColBase : public ExprBase< VisitorByCol<Derived, Visitor> >
{
  public:
    typedef ExprBase< VisitorByCol< Derived, Visitor> > Base;
 ...
 **/
template<typename Derived, template<class> class Visitor>
class VisitorByRow : public VisitorByRowBase< Derived, Visitor >, public TRef<1>
{
  public:
    typedef typename Derived::Type Type_;
    typedef typename Visitor<Type_>::return_type Type;
...
/** @ingroup SlicingVisitors
  ...
  **/
template<typename Derived, template<class> class Visitor>
class VisitorByRowBase : public ExprBase< VisitorByRow<Derived, Visitor> >
{
  public:
    typedef ExprBase< VisitorByRow< Derived, Visitor> > Base;
    typedef typename Base::Type Type;
